 ...
 */
public class VacantSpaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_vacant_space);
        ...
        if (extras != null) {
            ...
            hostelSpace = extras.getStringArrayList("SPACE");
