...
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart'; ///package that offers custom icons.
import 'package:url_launcher/url_launcher.dart'; ///package that launches URLs.
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      customLaunch("https://www.facebook.com/esoorapp/"); ///calling customLaunch() to launch urls adressed to the icon buttons/// 
                    },
                  ),
                  IconButton(
